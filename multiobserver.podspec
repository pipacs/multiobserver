#
#  Be sure to run `pod spec lint multiobserver.podspec' to ensure this is a
...
observations.
  ...
  # Or just: s.author    = "Akos Polster"
  # s.authors            = { "Akos Polster" => "akos@pipacs.com" }
  # s.social_media_url   = "http://twitter.com/Akos Polster"
